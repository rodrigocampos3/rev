  ...
  <div className="flex flex-col md:flex-row justify-center gap-6 w-full">
    ...
    <div className="flex flex-col items-center">
      ...
      <h3 className="mt-2 text-2xl font-medium">Tramontina</h3>
          ...
          <button className="w-2/3 bg-[#EB591E] rounded-xl md:text-3xl text-white font-bold py-3 text-center"> <a href="https://wa.me/5511962696366">Exponha na maior feira de construção civil das favelas do Brasil</a></button>
</div>
